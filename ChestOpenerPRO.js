...
(()=>{
  ...
  (()=>{
    ...
    description.innerHTML = 'さらなる条件を追加したプロ仕様。<br>F5:20 → ATK最小最大の合計20以上対象<br>F5::25 → SPD25以上対象<br>F5[火]:20 → 火属性でATK最小最大の合計20以上対象<br>F5[火]:20:25 → 火属性でATK最小最大の合計20以上でSPD25以上対象<br><br>硬化木の鎧:13 → DEF最小最大の合計13以上対象<br>硬化木の鎧::8 → WT8以上対象<br>硬化木の鎧[水]:13 → 水属性でDEF最小最大の合計13以上対象<br>硬化木の鎧[水]:13:8 → 水属性でDEF最小最大の合計13以上でWT8以上対象';
