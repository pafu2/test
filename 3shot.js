...
// @version      1.2.2d.パクリ9.4改 連射版 - 3発撃ち
 ...
 if (MODEQ === 'm=l') {
  ...
  (()=>{
    ...
    (()=>{
      ...
      link.textContent = 'arena assist tool - v1.2.2d.パクリ9.4改 連射版 - 3発撃ち';
...
//              }
            ...
            if (success) {
              if (currentProgress < 16) {
                nextProgress = Math.floor(Math.random() * 2 ) + 24;
               } else if (currentProgress < 32) {
                nextProgress = Math.floor(Math.random() * 2 ) + 40;
               } else if (currentProgress < 48) {
                nextProgress = Math.floor(Math.random() * 2 ) + 58;
               } else if (currentProgress < 66) {
                nextProgress = Math.floor(Math.random() * 2 ) + 74;
               } else if (currentProgress < 82) {
                nextProgress = Math.floor(Math.random() * 2 ) + 90;
               } else {
                nextProgress = Math.floor(Math.random() * 2 ) + 8;
               }
              next = `→ ${nextProgress}±5%`;
