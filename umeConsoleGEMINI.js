...
console.log('--- getRegions Debug ---');
console.log('teamColorSet size:', teamColorSet.size);
console.log('nonAdjacent:', regions.nonAdjacent.length);
console.log('teamAdjacent:', regions.teamAdjacent.length);
console.log('capitalAdjacent:', regions.capitalAdjacent.length);
console.log('mapEdge:', regions.mapEdge.length);
          return regions;
        } else {
          const regions = {
