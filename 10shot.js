...
// @version      1.2.2d.パクリ9.4改 連射版 - 10発撃ち
 ...
 if (MODEQ === 'm=l') {
  ...
  (()=>{
    ...
    (()=>{
      ...
      link.textContent = 'arena assist tool - v1.2.2d.パクリ9.4改 連射版 - 10発撃ち';
...
//              }
            ...
            if (success) {
              if (currentProgress < 6) {
                ...
                nextProgress = 58;
               } else if (currentProgress < 61) {
                nextProgress = 63;
               } else if (currentProgress < 66) {
                nextProgress = 68;
               } else if (currentProgress < 71) {
                nextProgress = 73;
               } else if (currentProgress < 76) {
                nextProgress = 78;
               } else if (currentProgress < 81) {
                nextProgress = 83;
