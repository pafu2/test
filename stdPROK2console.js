...
console.log('--- ターゲット確認 ---');
console.log('nonAdjacent数:', regions.nonAdjacent.length);
console.log('teamAdjacent数:', regions.teamAdjacent.length);
console.log('capitalAdjacent数:', regions.capitalAdjacent.length);
console.log('首都隣接の座標リスト:', regions.capitalAdjacent);
...
console.log('選択された判定タイプ:', cellType);
